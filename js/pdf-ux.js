$(document).ready(function () {
  try {
    ...
    let baseUrlSection = "/de-de/cloud-manager-cloud-volumes-service-aws/pdfs/";
    ...
    zipFilename = zipFilename !== ''?zipFilename:"cloud-manager-cloud-volumes-service-aws.de-de.zip";
